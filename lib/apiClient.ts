...
type AquascapeApiServiceType = unknown;
 ...
 */
export const apiClient = createClient<AquascapeApiServiceType>(
  // @ts-expect-error — service descriptor wired in once buf generate has run
  null,
  transport,
);
